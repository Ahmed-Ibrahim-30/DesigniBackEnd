...
#ifndef DESIGNI_BACKEND_LANDDIVISIONBASEDONMINIMIZESMALLDIMENSIONS_H
#define DESIGNI_BACKEND_LANDDIVISIONBASEDONMINIMIZESMALLDIMENSIONS_H
#include "LandDivision.h"

class LandDivisionBasedOnMinimizeSmallDimensions :public LandDivision{
private:
...
#endif //DESIGNI_BACKEND_LANDDIVISIONBASEDONMINIMIZESMALLDIMENSIONS_H
