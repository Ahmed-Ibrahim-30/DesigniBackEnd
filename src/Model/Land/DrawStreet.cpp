...
vector<vector<Line>> DrawStreet::drawExtensions(const vector<Line> &polygonLines, const vector<Line> &TopLine,
                                                const vector<Line> &bottomLine, double step) {
    return vector<vector<Line>>();
}
