...
private:
    ...
    void drawSide1Streets(const vector<Line> &polygonLines , const vector<Line> &centerL , vector<Line> &TopLine , double step  ,int divisions);
    ...
    int getMaxNumberOfDivisionsForLine(const Line &line , double initialStep , double initialStartStep, Polygon1 &boundryPolygon);
public:
